...
SHEETDB_API_URL = os.getenv("SHEETDB_API_URL", "https://sheetdb.io/api/v1/1hy1px2yn59g7")
...
VACANCY_NOTIFY_INTERVAL_SECONDS = get_int_env("VACANCY_NOTIFY_INTERVAL_SECONDS", 300)
